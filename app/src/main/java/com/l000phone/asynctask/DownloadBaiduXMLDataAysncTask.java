 ...
 * @version : 1.0
 */
public class DownloadBaiduXMLDataAysncTask extends AsyncTask<String, Void,LinkedList<BaiduNews>> {
	 ...
	 * @param dialog
	 */
	public DownloadBaiduXMLDataAysncTask(XMLDataSettingCallBack callBack,
	 ...
	 */
	@Override
	protected LinkedList<BaiduNews> doInBackground(String... params) {
		try {
			Log.i("UrlAddress",params[0]);
			...
			out.close();
			if (xmlfile.exists()) {
				LinkedList<BaiduNews> ds = ParseXmlStrUtils.parseXmlStrToBaiduItem(xmlfile);
...
//				}
	...
	@Override
	protected void onPostExecute(LinkedList<BaiduNews> result) {
...
//	}
	...
	public interface XMLDataSettingCallBack {
		// 给ImageView控件设置内容
		void setXMLData(LinkedList<BaiduNews> ds);
	}
